<template>
  ...
  <main class="thing-create">
    ...
    <section class="thing-create__header">
      ...
      <!-- CANCEL BUTTON -->
      <router-link :to="`/tableau-de-bord`" class="thing-create__cancel-edit-thing">
        <img class="thing-create__edit-thing-cancel-ico" src="@/assets/images/icon-cancel-edit-thing.svg" alt="Annulation de la création" />
      </router-link>
      <!-- SAVE BUTTON -->
      <button class="thing-create__save-edit-thing" @click="handleCreateThing">
        <img class="thing-create__edit-thing-cancel-ico" src="@/assets/images/icon-save-edit-thing.svg" alt="Validation de la creation" />
      </button>
    </section>
    <!-- HEADER // END -->
